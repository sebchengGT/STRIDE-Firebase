...
authentication_server <- function(input, output, session, 
  ...
  output$auth_page <- renderUI({
    ...
    # --- CHANGED: Google Button Label with SVG Icon ---
    google_btn_label <- HTML('
      <div style="display: flex; align-items: center; justify-content: center;">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" style="width: 18px; height: 18px; margin-right: 12px; display: block;">
          <g>
