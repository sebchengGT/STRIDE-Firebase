...
```{r, results='asis'}
render_info_table(params$df_enrol)
```
...
```{r, results='asis'}
render_info_table(params$df_teachers)
```

### <i class="glyphicon glyphicon-briefcase"></i> Non-Teaching Personnel Deployment
<div class="highlight-box">
  <span class="highlight-label">AO II Deployment</span>
  <span class="highlight-stat">`r val <- get_val(params$df_ntp, "AO II Deployment Status"); if(is.null(val)) "-" else val`</span>
</div>

```{r, results='asis'}
render_info_table(params$df_ntp)
```

### <i class="glyphicon glyphicon-home"></i> Infrastructure
<div class="highlight-box">
  <span class="highlight-label">Estimated Classroom Shortage</span>
  <span class="highlight-stat">`r val <- get_val(params$df_infra, "Estimated Shortage"); if(is.null(val)) "-" else val`</span>
</div>
```{r, results='asis'}
render_info_table(params$df_infra)
```
